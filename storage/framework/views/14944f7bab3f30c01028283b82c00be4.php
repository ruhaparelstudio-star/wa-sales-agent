<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50"
    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4 p-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'idle'): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'waiting'): ?>
            <div class="flex flex-col items-center py-8 gap-4">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'scanning'): ?>
            <div class="flex flex-col items-center py-8 gap-4">
                <template x-if="qrData">
                    <img :src="qrData" class="w-52 h-52 rounded-lg border border-gray-200" alt="QR Code">
                </template>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'connected'): ?>
            <div class="flex flex-col items-center py-8 gap-4">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'cancelled'): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'error'): ?>
            <div class="flex flex-col items-center py-6 gap-3">
                <p class="text-sm text-center text-red-600"><?php echo e($errorMessage ?? 'Unable to start pairing.'); ?></p>
                <button wire:click="initiatePairing" class="text-sm text-indigo-600 hover:underline">Try again</button>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</div>
<?php /**PATH /var/www/resources/views/livewire/whatsapp/qr-pairing-modal.blade.php ENDPATH**/ ?>