<div>
        ...
        <div class="flex items-start justify-between">
            <div>
                <div class="flex items-center gap-2 mb-1">
                    <a href="<?php echo e(route('leads.index')); ?>" class="text-sm text-gray-400 hover:text-gray-600">← Leads</a>
                </div>
                <h1 class="text-xl font-bold"><?php echo e($lead->name ?? $lead->phone_e164); ?></h1>
                <p class="text-sm text-gray-400 mt-0.5"><?php echo e($lead->phone_e164); ?> · <?php echo e($lead->status->value); ?> · <?php echo e($lead->whatsappAgent?->phone_number ?? 'No agent'); ?></p>
            </div>
        </div>
    </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = array_filter([
            ...
            <button wire:click="$set('activeTab', '<?php echo e($tab); ?>')"
                    class="px-4 py-2 text-sm font-medium border-b-2 -mb-px
                        <?php echo e($activeTab === $tab ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700'); ?>">
                <?php echo e($label); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'profile'): ?>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->profile): ?>
                    <dl class="space-y-2 text-sm">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = (array)$lead->profile->toArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!in_array($key, ['id','lead_id','created_at','updated_at']) && $value !== null): ?>
                                <div class="flex gap-3">
                                    <dt class="text-gray-400 w-32 flex-shrink-0"><?php echo e(ucwords(str_replace('_', ' ', $key))); ?></dt>
                                    <dd class="text-gray-800"><?php echo e(is_array($value) ? implode(', ', $value) : $value); ?></dd>
                                </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'conversation'): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($active_conversation): ?>
            <div class="bg-white rounded-xl border border-gray-200" wire:poll.3s.visible>
                <div class="flex items-center justify-between px-5 py-3 border-b border-gray-100">
                    <span class="text-sm font-medium">Conversation #<?php echo e($active_conversation->id); ?></span>
                    <div class="flex gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canTakeover && !$active_conversation->is_human_takeover): ?>
                            <button wire:click="takeover(<?php echo e($active_conversation->id); ?>)"
                                    wire:loading.attr="disabled"
                                    wire:target="takeover(<?php echo e($active_conversation->id); ?>)"
                                    class="text-xs px-3 py-1 bg-orange-500 text-white rounded-lg hover:bg-orange-600">
                                Takeover
                            </button>
                        <?php elseif($active_conversation->is_human_takeover): ?>
                            <span class="text-xs px-3 py-1 bg-gray-100 text-gray-600 rounded-lg">Human Takeover Active</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($active_conversation->isHandoff()): ?>
                ...
                <div class="p-4 space-y-3 max-h-[60vh] overflow-y-auto">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex <?php echo e($message->direction->value === 'inbound' ? 'justify-start' : 'justify-end'); ?>">
                            <div class="max-w-xs lg:max-w-md px-3 py-2 rounded-xl text-sm
                                <?php echo e($message->direction->value === 'inbound'
                                    ? 'bg-gray-100 text-gray-800'
                                    : ($message->is_from_ai ? 'bg-indigo-600 text-white' : 'bg-gray-600 text-white')); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($message->isMedia()): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_starts_with($message->media_mime ?? '', 'image/')): ?>
                                        <img src="<?php echo e($message->media_url); ?>" class="rounded-lg max-w-full" alt="Image">
                                    <?php else: ?>
                                        <div class="flex items-center gap-2">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                                            </svg>
                                            <span><?php echo e($message->media_filename ?? 'Document'); ?></span>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <p class="text-xs mt-1 opacity-60"><?php echo e($message->created_at->format('H:i')); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canTakeover): ?>
                    <div class="px-4 py-3 border-t border-gray-200 bg-gray-50 rounded-b-xl">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$active_conversation->is_human_takeover): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeTab === 'handoffs'): ?>
            ...
            <div class="divide-y divide-gray-100">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pending_handoffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $handoff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between px-5 py-4">
                        <div>
                            <p class="text-sm font-medium"><?php echo e($handoff->reason); ?></p>
                            <p class="text-xs text-gray-400"><?php echo e($handoff->created_at->diffForHumans()); ?></p>
                        </div>
                        <button wire:click="resolveHandoff(<?php echo e($handoff->id); ?>)"
                                wire:loading.attr="disabled"
                                wire:target="resolveHandoff(<?php echo e($handoff->id); ?>)"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canManageInvoices && $activeTab === 'invoices'): ?>
        <div class="space-y-4">
                ...
                <div class="divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center justify-between px-5 py-3 text-sm">
                            <div>
                                <p class="font-mono text-xs text-gray-500"><?php echo e($invoice->invoice_number); ?></p>
                                <p class="font-medium">Rp <?php echo e(number_format($invoice->amount, 0, ',', '.')); ?></p>
                            </div>
                            <div class="flex items-center gap-3">
                                <span class="text-xs px-2 py-0.5 rounded-full
                                    <?php echo e($invoice->status->value === 'paid' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'); ?>">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoice->status->value === 'draft'): ?>
                                    <button wire:click="sendInvoice(<?php echo e($invoice->id); ?>)"
                                            wire:loading.attr="disabled"
                                            wire:target="sendInvoice(<?php echo e($invoice->id); ?>)"
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <div class="space-y-3">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $lineItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex gap-2">
                            <input wire:model="lineItems.<?php echo e($i); ?>.description" placeholder="Description"
                                   class="flex-1 border border-gray-200 rounded px-3 py-1.5 text-sm">
                            <input wire:model="lineItems.<?php echo e($i); ?>.amount" type="number" placeholder="Amount"
...
<?php /**PATH /var/www/resources/views/livewire/leads/lead-detail.blade.php ENDPATH**/ ?>